...
export default function AdminLayout({
  ...
  return (
    <div className="min-h-screen bg-background relative overflow-hidden">
      ...
      <aside
        className={cn(
          "fixed left-0 top-0 z-40 h-screen w-72 transform border-r border-border/60 bg-card/30 backdrop-blur-2xl transition-transform duration-300 lg:translate-x-0 flex flex-col shadow-2xl",
